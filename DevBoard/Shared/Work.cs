        ...
        public static IEnumerable<Work> GetWorks()
        {
            var works = new List<Work>()
            {
                ...
                new Work(){
                    ...
                    Duration = 15,
                    Name = "DevBoard",
                    Description = @"Проверка измений git в эксплорере vs;",
                    WhatsUp = "Проверил работоспособность эксплорера git (хуета);" },                
                new Work(){
                    Start = new DateTime(2021, 12, 12, 17, 10, 0),
                    Duration = 22,
                    Name = "DevBoard",
                    Description = @"Поменять местами последнюю строку и Всего; Компонент для добавления новой работы;",
                    WhatsUp = "Добавил формочку для добавления новой работы;" },
                new Work(){
                    Start = new DateTime(2021, 12, 12, 0, 0, 0),
                    Duration = 0,
                    Name = "DevBoard",
                    Description = @"
Доработка формы добавления работ;
